...
-- --------------------------------------------------
-- Date Created: 12/19/2016 18:25:52
...
IF OBJECT_ID(N'[dbo].[FK__ACLforRes__Resou__5EBF139D]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ACLforResource] DROP CONSTRAINT [FK__ACLforRes__Resou__5EBF139D];
GO
IF OBJECT_ID(N'[dbo].[FK__ACLforRes__RoleI__5FB337D6]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ACLforResource] DROP CONSTRAINT [FK__ACLforRes__RoleI__5FB337D6];
GO
...
GO
IF OBJECT_ID(N'[dbo].[ACLforResource]', 'U') IS NOT NULL
    DROP TABLE [dbo].[ACLforResource];
GO
...
-- Creating table 'ACLforResources'
CREATE TABLE [dbo].[ACLforResources] (
...
-- Creating primary key on [Id] in table 'ACLforResources'
ALTER TABLE [dbo].[ACLforResources]
ADD CONSTRAINT [PK_ACLforResources]
...
-- Creating foreign key on [ResourceId] in table 'ACLforResources'
ALTER TABLE [dbo].[ACLforResources]
ADD CONSTRAINT [FK__ACLforRes__Resou__5EBF139D]
...
-- Creating non-clustered index for FOREIGN KEY 'FK__ACLforRes__Resou__5EBF139D'
CREATE INDEX [IX_FK__ACLforRes__Resou__5EBF139D]
ON [dbo].[ACLforResources]
    ([ResourceId]);
GO

-- Creating foreign key on [RoleId] in table 'ACLforResources'
ALTER TABLE [dbo].[ACLforResources]
ADD CONSTRAINT [FK__ACLforRes__RoleI__5FB337D6]
    FOREIGN KEY ([RoleId])
...
-- Creating non-clustered index for FOREIGN KEY 'FK__ACLforRes__RoleI__5FB337D6'
CREATE INDEX [IX_FK__ACLforRes__RoleI__5FB337D6]
ON [dbo].[ACLforResources]
    ([RoleId]);
GO
